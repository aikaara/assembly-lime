import type { FileChange } from "./git-operations";
import { logger } from "../lib/logger";

/**
 * Parses Claude's response into structured file changes.
 *
...
export function extractFileChanges(text: string): FileChange[] {
  ...
  logger.info({ fileCount: changes.length }, "extracted file changes from Claude response");
  return changes;
}
